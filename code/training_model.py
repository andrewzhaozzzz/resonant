...
from transformers import AutoModelForMaskedLM, TrainingArguments, Trainer, DataCollatorForLanguageModeling, AutoTokenizer, AdamW, get_scheduler
...
def finetune_model(pickle_path, col_name, save_name, num_paras = None):
    ...
    model = AutoModelForMaskedLM.from_pretrained('sentence-transformers/paraphrase-multilingual-mpnet-base-v2', num_labels=1)
    ...
    model_dir = f'{model_locat_dir}/{save_name}_final'
...
# First, train the model on the who leads who follows dataset
