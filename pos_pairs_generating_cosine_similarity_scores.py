...
def stratified_sample_similarity():
    save_name = "who_leads_intra_post_model"  # Updated save name for pos_pairs model
    embedding_output_dir = os.path.join(model_directory, "embedding_output")
    bins = [0.0, 0.5, 0.7, 0.8, 0.9, 1.01]  # using 1.01 to capture 1.0 scores
    samples_per_bin = 10
    ...
    for i in range(0, n_docs, block_size):
        ...
        for j in range(i, n_docs, block_size):
            ...
            sim_block = torch.mm(emb_i, emb_j.T)  # cosine similarity since embeddings are normalized
...
if __name__ == "__main__":
    ...
    if "hbailey" in filepath:
        ...
        model_directory = "/home/export/hbailey/models/embedding_resonance/who_leads_intra_post_model_final"
        ...
        model_directory = "/home/hannah/github/embedding_resonance/model/who_leads_intra_post_model_final"
